...
class MainWindow(CTk):
   def __init__(self,name):
       ...
       try:
           ...
           self.sock.connect(('7.tcp.eu.ngrok.io',11862))
   ...
   def toggle_show_menu(self):
       if self.is_show_menu:
           ...
           self.entry.pack()
           self.saveNameBtn = CTkButton(self.menu_frame,text="Зберегти ім'я",command=self.save_name)
           self.saveNameBtn.pack(pady=30)
...
class NameWindow(CTk):
    def __init__(self):
        ...
        self.btn = CTkButton(self,command=self.openApp, text='Увійти')
        self.btn.pack()
